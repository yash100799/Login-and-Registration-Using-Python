...
class Login_System:
    def __init__(self,root):
        self.root=root
        self.root.title("Login System | Developed by Yash Singh")
        ...
        #-------Animation Images------------#
        self.im1=ImageTk.PhotoImage(file="images/anim1.png")
        self.im2=ImageTk.PhotoImage(file="images/anim2.png")
        self.im3=ImageTk.PhotoImage(file="images/anim3.jpg")
